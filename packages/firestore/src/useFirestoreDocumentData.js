...
export function useFirestoreDocumentData(queryKey, ref, options, useQueryOptions) {
    ...
    var fetchFn = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, getSnapshot(ref, options === null || options === void 0 ? void 0 : options.source).then(function (snapshot) {
                    var _a;
                    var data = snapshot.data({
                        serverTimestamps: options === null || options === void 0 ? void 0 : options.serverTimestamps,
                    });
    ...
    return useSubscription(queryKey, ["useFirestoreDocument", ref.id], subscribeFn, __assign(__assign({}, useQueryOptions), { queryKey: queryKey, onlyOnce: !isSubscription, fetchFn: fetchFn }));
}
