...
export function useFirestoreQueryData(queryKey, query, options, useQueryOptions) {
    var _this = this;
    ...
    var fetchFn = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, resolveQuery(query)];
                case 1:
                    resolvedQuery = _a.sent();
                    return [4 /*yield*/, getQuerySnapshot(resolvedQuery, options === null || options === void 0 ? void 0 : options.source)];
                case 2:
                    snapshot = _a.sent();
    ...
    return useSubscription(queryKey, ["useFirestoreDocument", queryKey], subscribeFn, __assign(__assign({}, useQueryOptions), { queryKey: queryKey, onlyOnce: !isSubscription, fetchFn: fetchFn }));
}
